...
# 读取DQN数据
with open('./DQN_reward.json', 'r') as f:
...
# 设置标题和标签
plt.title('DQN vs DDQN Training Reward Comparison', fontsize=14)
...
# 保存图片
plt.savefig('dqn_ddqn_comparison.png', dpi=300, bbox_inches='tight')
plt.close()
